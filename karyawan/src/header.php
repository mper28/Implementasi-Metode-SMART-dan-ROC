...
include '../koneksi.php';
$ambil  = mysqli_query($koneksi, "SELECT * FROM data_karyawan WHERE id_karyawan = '$_SESSION[id]'");
...
<head>
    ...
    <title>IMPLEMENTASI METODE SIMPLE MULTI ATTRIBUTE RATING TECHNIQUE DENGAN PEMBOBOTAN RANK ORDER CENTROID DALAM PENENTUAN PRIORITAS TICKETING PENANGANAN GANGGUAN PADA APLIKASI HELPDESK DI BGES OPERATION WITEL CIREBON</title>
                ...
                <div class="user">
                    ...
                    <div class="info">
                        ...
                        <div class="collapse" id="collapseExample">
                            <ul class="nav">
                                <li>
                                    <a href="data_karyawan.php">Profil </a>
                                </li>
                                <li>
